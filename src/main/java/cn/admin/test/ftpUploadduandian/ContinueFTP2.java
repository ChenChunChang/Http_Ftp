...
//	}
	...
	private String ftpURL, username, pwd, ftpport, fileUrl,fileName ;// file2;

	public ContinueFTP2(String _ftpURL, String _username, String _pwd, String _ftpport, String _fileUrl,String _fileName) {
		// 设置将过程中使用到的命令输出到控制台
		ftpURL = _ftpURL;
		username = _username;
		pwd = _pwd;
