				...
				<div class="right_box">
					<div style="border: none; box-shadow: none;" class="right_one row">
						<div class="col-md-12 col-sm-12 col-xs-12" style="float: left;">
							<form action="" class="form-horizontal" method="post" id="saveClient" >
								<input type="hidden" name="dictionaryId" style="width: 240px"
									value="${dic.dictionaryId }" />
								<div class="form-group">
									<label class="col-lg-2 col-md-2 col-sm-3 control-label"><span
										style="color: red;">*</span>项目名称:</label>
									<div class="col-md-6 col-lg-6 col-sm-6">
										<input type="text" name="dictionaryName"
											class="form-control required" id="dictionaryName"
											value="${dic.dictionaryName }" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-lg-2 col-md-2 col-sm-3 control-label">描述:</label>
									<div class="col-md-6 col-lg-6 col-sm-6">
										<textarea name="dictionaryDescription" class="form-control">${dic.dictionaryDescription }</textarea>
									</div>
								</div>
								<div class="form-group">
									<label class="col-lg-2 col-md-2 col-sm-3 control-label">类型:</label>
									<div class="col-md-6 col-lg-6 col-sm-6">
										<select name="dictionaryType" class="form-control">
											<option value="">无</option>
											<c:forEach items="${typeList}" var="item">
												<option value="${item.dictionaryType}"
													<c:if test="${item.dictionaryType eq dic.dictionaryType}"> selected="selected"</c:if>>${item.dictionaryType}</option>
											</c:forEach>
										</select>
									</div>
								</div>
